        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Programme = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    YearOfStudy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ExpectedGraduationYear = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyRepresentatives_CompanyProfiles_CompanyProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Compensation = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    StipendAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Currency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    EligibleProgrammes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    PublishedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Views = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    ApplicationsCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    ...
                    LastModeratedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortlistNotes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InternshipApplications_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyProfiles_City",
                table: "CompanyProfiles",
                column: "City");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyProfiles_Country",
                table: "CompanyProfiles",
                column: "Country");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyRepresentatives_CompanyProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternshipApplication_Student_Internship_Unique",
                table: "InternshipApplications",
                columns: new[] { "StudentProfileId", "InternshipId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InternshipApplications_CreatedAt",
                table: "InternshipApplications",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternshipApplications_IsShortlisted",
                table: "InternshipApplications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternshipApplications_StudentProfileId",
                table: "InternshipApplications",
                column: "StudentProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Internships_Industry",
                table: "Internships",
                column: "Industry");

            migrationBuilder.CreateIndex(
                name: "IX_Internships_Location",
                table: "Internships",
                column: "Location");

            migrationBuilder.CreateIndex(
                name: "IX_Internships_ModerationStatus",
                table: "Internships",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentProfiles_Location",
                table: "StudentProfiles",
                column: "Location");

            migrationBuilder.CreateIndex(
                name: "IX_StudentProfiles_Programme",
                table: "StudentProfiles",
                column: "Programme");

            migrationBuilder.CreateIndex(
                name: "IX_StudentProfiles_University",
                table: "StudentProfiles",
                column: "University");
